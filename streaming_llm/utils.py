...
def parse_args():
    ...
    parser.add_argument(
        "--model_name_or_path", type=str, default="/media/orange/Ubuntu_data/model/models-meta-llama-Llama-2-7b-chat-hf"
    )
    ...
    parser.add_argument("--recent_size", type=int, default=2040)
    parser.add_argument("--enable_pos_shift", action="store_true")

    parser.add_argument("--num_eval_tokens", type=int, default=None)
    
    parser.add_argument("--generation_method", type=str, default="normal")
    
    parser.add_argument("--statistics_size", type=int, default=128)
