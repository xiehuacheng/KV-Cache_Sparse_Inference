...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default="./datasets/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json")
...
def plot_attn_map(args, attns):
    for layer in tqdm(range(0, len(attns), 1)):
        # set up the figure and axes
        fig = plt.figure()
...
def main(args):
    ...
    # get attn
    args.num_tokens = 128    # for better visualization
